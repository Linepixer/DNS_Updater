...
class Patcher(Chrome_Version, object):
    ...
    def fetch_package(self):
        ...
        print("FAKE >> Downloading chromedriver")
    ...
    def unzip_package(self, fp):
        ...
        os.system("cp ~/.local/share/undetected_chromedriver/chromedriver_101_OK ~/.local/share/undetected_chromedriver/chromedriver")
        print("INFO >> Copied version of chromedriver compatible with Chromium v101")
